...
function user_setup()
    ...
    send_command('bind ^numpad7 gs equip sets.Weapons.Liberator ; gs c update_if_weapon')
    send_command('bind numpad7 gs equip sets.Weapons.Foenaria; gs c update_if_weapon')
    send_command('bind numpad8 gs equip sets.Weapons.Caladbolg ; gs c update_if_weapon')
