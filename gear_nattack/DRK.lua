...
function include_job_sets()
    ...
    -- WS augs
    gear.torcleaver_helm = { name = "Odyssean Helm",
        augments = { 'Mag. Acc.+23', 'Weapon skill damage +3%', 'VIT+10', 'Attack+2', } }
    gear.torcleaver_gauntlets = { name = "Odyssean Gauntlets",
        augments = { 'VIT+9', 'Enmity+5', 'Weapon skill damage +3%', 'Accuracy+13 Attack+13',
    ...
    sets.midcast['Endark'] = set_combine(sets.midcast['Dark Magic'],
        { back = "Niht Mantle", ear1 = "Dark Earring", legs = "Heathen's Flanchard +1", ring2 = "Stikini Ring +1",
            waist = "Casso Sash" })
    ...
    sets.midcast['Elemental Magic'] = { ammo = "Ghastly Tathlum +1",
        head = "Flamma Zucchetto +2", neck = "Sibyl Scarf", ear1 = "Malignance Earring", ear2 = "Friomisi Earring",
        body = "Carmine Scale Mail +1", hands = "Fallen's Finger Gauntlets +3", ring1 = "Stikini Ring +1",
        ring2 = "Metamorph Ring +1",
    ...
    sets.engaged.Low = { ammo = "Seething Bomblet +1",
        ...
        body = "Flamma Korazin +2", hands = "Gazu Bracelet +1", ring1 = "Regal Ring", ring2 = "Moonlight Ring",
