...
function include_job_sets()
    ...
    sets.precast.WS['Savage Blade'] = set_combine(sets.precast.WS, { ammo = "Voluspa Tathlum", neck = "Republican Platinum medal", waist = "Sailfi Belt +1" })
    ...
    sets.midcast.FastRecast = { ammo = "Sapience Orb",
        ...
        back = "Fi Follet Cape +1", waist = "Witful Belt", legs = "Atrophy Tights +3", feet = "Vitiation boots +3" }
